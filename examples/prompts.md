...
These prompts target the **Lecture Notes** format (`# PAGE_N:` blocks + Ekphrasis + empty `## Note`).

## Single batch (10 pages)

- “Transcribe `/path/to/Lecture 01.pdf` into `/path/to/Lecture 01.md`.
...
## Animation spans multiple pages

- “If pages 4–6 are the same animated sequence, merge them into a single block header `# PAGE_4-6:` and combine their Content in order.”
...
- “Keep the slide’s original language exactly; do not translate. Transcribe all visible text as-is.”
